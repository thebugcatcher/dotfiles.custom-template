...
RUN git clone https://github.com/aditya7iyengar/dotfiles /dotfiles

ENV CUSTOM_REPO_URL=https://github.com/aditya7iyengar/dotfiles.custom-template

RUN bash /dotfiles/installer.sh
